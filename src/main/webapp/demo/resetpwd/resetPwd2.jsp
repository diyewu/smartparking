...
<%
	...
	if(StringUtils.isBlank(preUrl) || !preUrl.contains("resetPwd1.jsp")){
...
function sendCode(thisBtn) {
	...
	$.post(path+"/webctrl/resetPwdMailCode/", 
		{
    		email:temail
		},
		function(result){
...
function checkCode(){
	...
	$.post(path+"/webctrl/resetPwdCheckMailCode/", 
		{
    		code:emailcode
		},
		function(result){
			if(result.success == true){//登陆成功
				window.location.href="resetPwd3.jsp"; 
			}else {
